...
import './DetergentProductItem.css';
import {Link} from 'react-router-dom';
import * as actions from  '../../../UseOfRedux/actions'
import {connect} from 'react-redux'

class DetergentProductItem extends Component {
...
export default connect(mapStateToProps, mapDispatchToProps)(DetergentProductItem);
