...
import './DetergentProductDetail.css'
...
class DetergentProductDetails extends Component {
...
const mapStateToProps =state=>({
 ...
 export default connect(mapStateToProps, mapDispatchToProps)(DetergentProductDetails);
