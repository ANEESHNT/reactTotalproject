...
import './FreshvegProductDetail.css'
...
class FreshVegProductDetails extends Component {
...
const mapStateToProps =state=>({
 ...
 export default connect(mapStateToProps, mapDispatchToProps)(FreshVegProductDetails);
