...
class FlourProductDetails extends Component {
...
const mapStateToProps =state=>({
     count: state.FlourFetchPost.count
 })
 ...
 export default connect(mapStateToProps, mapDispatchToProps)(FlourProductDetails);
