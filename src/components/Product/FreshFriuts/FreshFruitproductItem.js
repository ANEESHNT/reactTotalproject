...
import './FreshFruitProductItem.css';
import {Link} from 'react-router-dom';
import * as actions from  '../../../UseOfRedux/actions'
import {connect} from 'react-redux'

class FreshFruitProductItem extends Component {
...
export default connect(mapStateToProps, mapDispatchToProps)(FreshFruitProductItem);
