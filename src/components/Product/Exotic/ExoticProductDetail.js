...
import './ExoticProductDetail.css'
...
class ExoticProductDetails extends Component {
...
const mapStateToProps =state=>({
 ...
 export default connect(mapStateToProps, mapDispatchToProps)(ExoticProductDetails);
